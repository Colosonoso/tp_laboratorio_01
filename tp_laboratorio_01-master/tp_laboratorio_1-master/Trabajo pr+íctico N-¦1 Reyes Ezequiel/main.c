       ...
       if(flagnumero1==1 && flagnumero2==1)
         {
          ...
          if(numerodos<=0)
            {
              printf("Error.El numerodos tiene que ser distinto de 0,ya que no se puede dividir por o menos de 0.\n Reingrese\n");
            }
           ...
           if(numerouno<0)
            {
            printf("Error.El factorial de un numero que este en negativo no existe.\n");
            }
            else
            {
